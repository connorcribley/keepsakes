...
const Listing = (/* {
  ...
  const items: Item[] = [
    {src: "items/rocking_horse_oyhqq9", name: "Rocking Horse", price: 25},
    {src: "items/soccer_ball_xozmbs", name: "Soccer Ball", price: 15},
    {src: "items/painting1_ao3juc", name: "Painting", price: 50},
    {src: "items/clothes2_ydz8sl", name: "Clothes", price: 30},
    {src: "items/books1_mcy17h", name: "Books", price: 10},
    {src: "items/bike_du9pbg", name: "Bicycle", price: 100},
    {src: "items/albums5_jbfaxj", name: "Vinyl Albums", price: 40},
    {src: "items/television1_qlusja", name: "Television", price: 200},
    {src: "items/teapot_hkn4tw", name: "Teapot", price: 20},
    {src: "items/stereo1_hnxzqj", name: "Stereo", price: 30},
    {src: "items/teddy_bear_dealkk", name: "Teddy Bear", price: 15},
    {src: "items/lamp_ac8t4k", name: "Lamp", price: 35},
    {src: "items/blender_y2f4yb", name: "Blender", price: 45},
    {src: "items/doll_pwrlt5", name: "Doll", price: 20},
    {src: "items/basket_ball_fny6bs", name: "Basketball", price: 18},
  ]

  return (
    <div className="border-2 border-gray-200 rounded-2xl p-4 text-gray-200 shadow-sm mx-auto w-full max-w-6xl m-2">
